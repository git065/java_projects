...
import com.adslur.szt.gui.JAddDemand;
...
public class SettingView extends JDialog {
	...
	private static JDemandMain opt = JDemandMain.getInstance();
	JAddDemand addDem = null;
	AboutDialog about = null;
	JNaradDemand nrd = null;
