...
public class AboutDialog extends JDialog {
	...
	public void dialogInit() {
		...
		JLabel textLabel1 = new JLabel("СЭПСС");
		panel2.add(textLabel1);
		JLabel textLabel2 = new JLabel(
				"Copyright (c) 2012 Открытое акционерное общество «Ростелеком»");
		panel2.add(textLabel2);
		JLabel textLabel3 = new JLabel("Web site http://www.step.ru");
       ...
       private Animation createAnimation() {
        Animation welcome =
            BasicTextAnimation.defaultFade(
                label1,
                2500,
                "Вас приветствует  приложение  GUI_SEPPS ",
                Color.RED);
       ...
       Animation list =
        ...
        Animation description =
            BasicTextAnimations.defaultFade(
                ...
                2000,
                -100,
                "1. Значительно облегчить себе жизнь при |" +
                "поиске данных из системы  СЭППС|формированию отчетов из системы  СЭППС.",
                Color.BLUE);
