...
import com.sepps.szt.panel.ReportUser;

import com.sepps.szt.renderers.UIDefaultsPopup;
import com.sepps.szt.renderers.UIDefaultsPopupDialog;

public class JSvodksUser extends JInternalFrame implements ActionListener {
	...
	/*
	 * OutLookToolBar m_tlbBar = null; JToolBar m_toolbar;
	 */
	...
	public JSvodksUser() {
		// initComponents();
		setSize(400, 500);
		setTitle("Сводка по пользователям");
		setMaximizable(true);
		setIconifiable(true);
		setClosable(true);
		setResizable(true);
